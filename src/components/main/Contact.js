    ...
    <><div className="container">
        ...
        <section className="home__contact " >
                    ...
                    <div className="home__contact__data">
                        ...
                        <p>
                            De lunes a sábado:<br/> <strong>10:00–15:00 / 18:00–23:30</strong>
                        </p>
                    </div>
        </section>
        </div>
