    ...
    <section className="home__about__box ">
      ...
      <article className="home__about__article">
        ...
        <p>
          ...
          todas sus modalidades en un ambiente amigable y con encanto. También
          podrás degustar nuestras tablas de queso en tu casa, realizando
          previamente tu{" "}
          <a id="pedido" href="#contact">
            Pedido
          </a>
          .
        </p>
        <div className="home_contact_socialmedia">
          ...
          <nav className="home__contact__icon">
            <a href="https://www.facebook.com/LasViudasCheeseBar/">
              <img
                className="home__contact__icon__link"
                src={facebook}
                alt="facebook"
              />
            </a>
